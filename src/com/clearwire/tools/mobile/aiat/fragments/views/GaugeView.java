package com.clearwire.tools.mobile.aiat.fragments.views;
...
public class GaugeView extends View {
	...
	private static final String sTag = "GaugeView";
	...
	private void drawBackground(final Canvas canvas) {
		if (null == mBackground) {
			Log.e(sTag, "Background not created.");
		}
		else {
	...
	private void drawText(final Canvas canvas) {
		...
		final float startY = CENTER - 0.075f;
